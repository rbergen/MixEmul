namespace MixLib.Type
{
	public static class ExtensionMethods
	{
		public static long ApplyTo(this Word.Signs sign, long magnitude)
			=> sign == Word.Signs.Negative ? -magnitude : magnitude;
		...
		public static Word.Signs GetSign(this long value)
			=> value < 0 ? Word.Signs.Negative : Word.Signs.Positive;
		...
		public static Word.Signs Invert(this Word.Signs sign)
			=> sign == Word.Signs.Positive ? Word.Signs.Negative : Word.Signs.Positive;
		...
		public static Word.Signs ToSign(this char c)
			=> c == '-' ? Word.Signs.Negative : Word.Signs.Positive;
		...
		public static Registers.CompValues Next(this Registers.CompValues current)
			=> current switch
			{
				Registers.CompValues.Equal => Registers.CompValues.Greater,
				Registers.CompValues.Greater => Registers.CompValues.Less,
				_ => Registers.CompValues.Equal,
			};

		public static char ToChar(this Registers.CompValues compValue)
			=> compValue switch
			{
				Registers.CompValues.Less => '<',
				Registers.CompValues.Equal => '=',
				Registers.CompValues.Greater => '>',
				_ => '?',
			};
